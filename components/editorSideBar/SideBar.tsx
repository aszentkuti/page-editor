							...
							<>
								...
								<Box pl={3}>
									...
									<Grid container alignItems="center">
										<Grid item xs>
											<Slider
												marks={[{value:0.5625, label:"16/9"},{value:0.75, label:"4/3"}]}
												step={0.01}
												min={0.1}
												max={1}
												onChange={(
									...
									<Grid container alignItems="center">
										<Grid item xs>
											<Slider
												marks={[{value:1.5, label:"x1.5"},{value:2, label:"x2"},{value:2.5, label:"x2.5"},{value:3, label:"x3"}]}
												step={0.1}
												min={1}
												max={3}
												onChange={(
													...
													selectedBox.zoom = value;
												}}
												value={selectedBox.zoom}
												defaultValue={selectedBox.zoom}
												aria-label="zoom"
												valueLabelDisplay="auto"
											/>
										</Grid>
